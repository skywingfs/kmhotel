<?php /* Smarty version Smarty-3.1.18, created on 2015-07-21 09:58:14
         compiled from "C:\wamp\www\kmhotel\app\views\column\add.html" */ ?>
<?php /*%%SmartyHeaderCode:1559655adfb96e869d5-34258534%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1559655adfb96e869d5-34258534',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55adfb9718de43_24220144',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55adfb9718de43_24220144')) {function content_55adfb9718de43_24220144($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                <li class="active"><i class="fa fa-dashboard"></i>&nbsp;&nbsp;&nbsp;添加栏目
                </li>
            </ol>
            <h1>添加栏目
<hr/>
...
?>
                        ...
                        <div class="form-group" style="">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" id="title"
                                       placeholder="栏目名称" name="cateName" style="width:40%">
                            </div>
                        </div>
                        ...
                        <div class="form-group" style="">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" id="pinyin"
                                       placeholder="栏目拼音" name="pinyin" style="width:40%">
                            </div>
                        </div>
                        ...
                        <div class="form-group" style="">
                            ...
                            <div class="col-md-10" id="type">
                                <input type="radio" name="type"  id="" value="0" checked="checked"/>封面
                                <br/>
